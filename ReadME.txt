...
This program is built using 3 C files. 
	1. readfile.h		- Declares the functions used in the program
	2. readfile.c		- Defines the function used in the program
	3. workerDB.c		- Contains the main method to run the program

Source codes are included in the repository, for reference.

How to RUN (on a windows OS Command Line)
----------------------------
...
4. Enter in the command line : gcc workerDB.c -o workerDB
...
Credits
-------
This project was developed as part of the SP-Lab1 assignment of the course CS402 at the Illinois Institue of Technology, under guidance from Professor Virgil Bistriceanu and Teaching Assistant Aashesh Kumar.
